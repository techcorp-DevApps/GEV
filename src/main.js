...
import { flyToMelbourne } from './camera.js';
...
async function init() {
  ...
  try {
    ...
    // If no share link state, do the default fly-to Melbourne
    if (!styleManager.hasShareState) {
      loaderStatus.textContent = 'Flying to Melbourne, Australia...';
      flyToMelbourne(viewer);
    } else {
